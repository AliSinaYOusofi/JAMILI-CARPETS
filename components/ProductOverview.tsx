...
const ProductOverview: React.FC<{ name: string }> = ({ name }) => {
            ...
            <div className="px-4 mx-auto 2xl:px-0">
                <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                    <div className="relative">
                        <Image
                            className={`object-cover h-[50vh] md:h-[70vh] lg:h-[100vh] ml-5 w-full rounded-lg shadow-lg`}
                    ...
                    <div className="mt-6 sm:mt-8 lg:mt-0">
                        ...
                        >
                            ...
                            <path
                                ...
                                strokeWidth="2"
                                d="M12.01 6.001C6.5 1 8 5.782 13.001L12.011 20l6.23-7C23 8 17.5 1 12.01 6.002Z"
                            />
                            </svg>
                            Add to favorites
                        </button> */}
